...
When user's choice is batting, user must hit numbers ranging from 1-6 and if the PC's number is different from the user's number, it results in a score being added.
